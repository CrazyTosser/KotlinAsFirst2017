...
class Tests {
    ...
    fun bishopMoveNumber() {
        ...
        assertEquals(2, bishopMoveNumber(square("a1"), square("h4")))
        assertEquals(1, bishopMoveNumber(Square(3, 8), Square(8, 3)))
    }
    ...
    fun kingMoveNumber() {
        ...
        assertEquals(4, kingMoveNumber(square("f7"), square("h3")))
        assertEquals(2, kingMoveNumber(Square(2, 5), Square(4, 4)))
    }
